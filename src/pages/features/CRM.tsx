...
const FAQS = [
  { q: 'Which channels does CRM support?', a: 'WhatsApp Business, Instagram and Facebook Messenger all flow into one shared inbox. Your team replies from a single screen, and every conversation clearly shows which channel it came from.' },
  ...
  { q: 'Do I need to replace my existing tools?', a: 'No. CRM connects your WhatsApp, Instagram and Facebook alongside your CRM and payments — one layer on top of your stack, not a rip-and-replace.' },
];
      ...
      <div className="bg-[#092511] shadow-[0_0_0_100vmax_#092511] [clip-path:inset(0_-100vmax)] shrink-0 w-full">
        <div className="container mx-auto border-x border-[rgba(255,255,255,0.08)] px-4 xl:px-[75px] py-[100px] flex flex-col items-center text-center relative overflow-hidden">
          ...
          <Typography component="h1" className="font-['Geist:SemiBold'] font-semibold leading-[1.15] text-white text-[60px] tracking-[-2px] max-w-[800px] mb-[24px] relative">
            Customer CRM.<br /><span className="text-[#25d366]">Unified</span> Contact History.
          </Typography>
          <Typography className="font-['Geist:Regular'] text-[#a0b8a8] text-[20px] max-w-[680px] leading-[1.6] mb-[44px] relative">
            Centralize contacts, order history, custom tags and conversation threads into a single source of truth for your entire team.
          </Typography>
