...
function PlatformMock() {
  const kpis = [
    { l: 'Appointments · 30d', v: '1,240', d: '+28%', ic: <><rect x="3" y="4" width="18" height="18" rx="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /></> },
    { l: 'Patients', v: '3,180', d: '+15%', ic: <><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /></> },
    { l: 'Show rate', v: '92%', d: '+11pp', ic: <><polyline points="23 6 13.5 15.5 8.5 10.5 1 18" /><polyline points="17 6 23 6 23 12" /></> },
    { l: 'Avg reply', v: '0.5s', d: '−90%', ic: <><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 2" /></> },
  ];
  const feed = [
    { ch: 'wa', c: '#25d366', t: 'Aarav: Book Dr. Rao · Fri 5 PM?', tag: 'WhatsApp', tm: '2m' },
    { ch: 'pay', c: '#06b349', t: '₹1,200 received · Invoice #INV-88', tag: 'Payments', tm: '5m' },
    { ch: 'cart', c: '#c98a3a', t: 'Lab report sent · CBC', tag: 'Reports', tm: '7m' },
    { ch: 'web', c: '#3f6cab', t: 'Website · appointment request', tag: 'Website', tm: '10m' },
    { ch: 'wa', c: '#25d366', t: 'AI answered “clinic timings?”', tag: 'WhatsApp', tm: '13m' },
    { ch: 'ig', c: '#E1306C', t: 'DM — “Do you have pediatrics?”', tag: 'Instagram', tm: '16m' },
  ];
  const integ = [
    { n: 'WhatsApp', ic: imgWhatsApp }, { n: 'Instagram', ic: imgInstagram }, { n: 'Website', dot: '#3f6cab' },
    { n: 'Google', dot: '#ea4335' }, { n: 'Razorpay', dot: '#0C4D9E' }, { n: 'EHR', dot: '#7F54B3' },
  ];
  return (
...
function AiReplyMock() {
  const convos = [
    { i: 'A', bg: '#d8f3e3', c: '#0a8f5a', n: 'Aarav Shah', p: 'What are the clinic timings?', ai: true, sel: true, t: '0.4s' },
    { i: 'M', bg: '#fde2e8', c: '#d9577e', n: 'Meera Iyer', p: 'Do you have a cardiologist?', ai: true, t: '0.5s' },
    { i: 'R', bg: '#dbeafe', c: '#3f6cab', n: 'Rohan Das', p: 'Consultation fee?', ai: true, t: '0.3s' },
    { i: 'S', bg: '#d8f3e3', c: '#0a8f5a', n: 'Sofia Menon', p: 'Need a home visit', esc: true },
    { i: 'K', bg: '#fde2e8', c: '#d9577e', n: 'Karan Malhotra', p: 'Where are you located?', ai: true, t: '0.6s' },
  ];
  const stats = [{ l: 'Staff time saved', v: '5.5h' }, { l: 'Auto-resolved', v: '94%' }, { l: 'Avg reply', v: '0.5s' }, { l: 'Patients today', v: '318' }];
  return (
      ...
      <div className="flex-1 flex min-h-0">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="flex-1 px-[24px] py-[18px] flex flex-col gap-[12px] overflow-hidden" style={{ background: '#f6f8fa' }}>
            <div className="self-start bg-white rounded-[12px] rounded-tl-[3px] px-[14px] py-[9px] shadow-sm max-w-[70%]"><Typography className="text-[#0c221f] text-[13px]">What are the clinic timings?</Typography></div>
            <div className="self-end flex flex-col items-end gap-[3px] max-w-[74%]"><div className="bg-[#dcf8e8] rounded-[12px] rounded-tr-[3px] px-[14px] py-[9px]"><Typography className="text-[#0c221f] text-[13px] leading-[1.45]">Open 9 AM–8 PM, Mon–Sat. Book a slot below 🩺</Typography></div><div className="flex items-center gap-[4px]"><Typography className="font-['Courier_Prime'] text-[#06824f] text-[9.5px]">✦ AI · 0.4s</Typography><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#34b7f1" strokeWidth="2.5"><polyline points="18 7 9.5 16 7 13.5" /><polyline points="23 7 14.5 16 14 15.5" /></svg></div></div>
            <div className="self-end bg-[#0b1f17] rounded-[12px] rounded-tr-[3px] px-[14px] py-[10px] max-w-[60%] flex items-center gap-[10px]"><div className="size-[30px] rounded-[8px] bg-[#06b349] flex items-center justify-center shrink-0"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><rect x="3" y="11" width="18" height="11" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg></div><div><Typography className="text-white text-[12.5px] font-['Geist:SemiBold']">Dr. Rao · ₹600</Typography><Typography className="text-[#8fdcae] text-[10.5px]">consultation · book now</Typography></div></div>
            ...
            <div className="self-start bg-white rounded-[12px] rounded-tl-[3px] px-[14px] py-[9px] shadow-sm max-w-[70%]"><Typography className="text-[#0c221f] text-[13px]">Can I get a home visit?</Typography></div>
          </div>
...
function ConversationMock() {
  const cols = [
    { t: 'Upcoming', n: 42, c: '#94a3b8', cards: [{ n: 'Aarav S.', s: 40, m: 'Dr. Rao · Fri 5 PM', ch: '#25d366' }, { n: 'Vikram S.', s: 32, m: 'Dental · Sat 11 AM', ch: '#E1306C' }] },
    { t: 'Reminded · 24h', n: 22, c: '#3f6cab', cards: [{ n: 'Meera I.', s: 62, m: 'Reminder sent · 24h', ch: '#25d366' }, { n: 'Dev K.', s: 55, m: 'Reminder sent · 24h', ch: '#1877F2' }] },
    { t: 'Confirmed', n: 16, c: '#7c5bd6', cards: [{ n: 'Riya N.', s: 80, m: 'Confirmed on WhatsApp', ch: '#25d366' }, { n: 'Arjun P.', s: 74, m: 'Rescheduled to Mon', ch: '#E1306C' }] },
    { t: 'Attended', n: 11, c: '#06b349', cards: [{ n: 'Sofia M.', s: 98, m: 'Visit completed', ch: '#25d366', hot: true }, { n: 'Kabir M.', s: 93, m: 'Follow-up booked', ch: '#1877F2', hot: true }] },
  ];
  return (
    <AppShell activeTop="Automations">
      <ContentHeader title="Reminders" badge={<span className="bg-[#e5f6e7] text-[#06824f] text-[11px] font-['Geist:Medium'] px-[10px] py-[3px] rounded-full">✦ Auto reminders</span>} right={<><Typography className="font-['Geist:Regular'] text-[#94a3b8] text-[12.5px]">86 appointments · auto reminders</Typography><div className="h-[34px] rounded-[9px] bg-[#06b349] flex items-center px-[13px] gap-[6px]"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5"><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" /></svg><Typography className="text-white text-[12.5px] font-['Geist:Medium']">New flow</Typography></div></>} />
...
function CartRecoveryMock() {
  const funnel = [{ l: 'Generated', v: '2,180', p: 100, c: '#c98a3a' }, { l: 'Sent', v: '2,140', p: 98, c: '#3f6cab' }, { l: 'Delivered', v: '2,090', p: 96, c: '#7c5bd6' }, { l: 'Viewed', v: '1,880', p: 86, c: '#06b349' }];
  const seq = [{ a: 'Report generated', d: 'CBC · ready', t: '', done: true }, { a: 'Sent on WhatsApp', d: 'Secure PDF link', t: '', done: true }, { a: 'Viewed by patient', d: 'Read receipt ✓', t: '', done: true, win: true }];
  const rows = [
    { n: 'Aarav Shah', it: 'Lab report · CBC', v: '₹1,200', st: 'Viewed' },
    { n: 'Meera Iyer', it: 'Prescription', v: '₹600', st: 'Sent' },
    { n: 'Kabir Mehta', it: 'Invoice #INV-88', v: '₹1,200', st: 'Viewed' },
    { n: 'Sofia Menon', it: 'X-ray report', v: '₹850', st: 'Sent' },
  ];
  return (
    <AppShell activeTop="Commerce">
      <ContentHeader title="Reports & Billing" badge={<span className="flex items-center gap-[6px] bg-[#e5f6e7] rounded-full px-[11px] py-[4px]"><span className="size-[6px] rounded-full bg-[#06b349] step-live-dot" /><Typography className="text-[#06824f] text-[11.5px] font-['Geist:Medium']">Automation ON</Typography></span>} right={<span className="bg-[#06b349] text-white text-[12px] font-['Geist:SemiBold'] px-[12px] py-[6px] rounded-[9px]">98% delivered</span>} />
      <div className="flex-1 p-[18px] flex flex-col gap-[14px] overflow-hidden">
        <div className="bg-white border border-[#eef1f4] rounded-[14px] p-[18px]">
          <div className="flex items-center justify-between mb-[14px]"><Typography className="font-['Geist:SemiBold'] font-semibold text-[#0c221f] text-[14px]">Documents sent · this week</Typography><Typography className="font-['Courier_Prime'] text-[#06824f] text-[12px]">2,140 docs delivered</Typography></div>
        ...
        <div className="grid grid-cols-[1fr_1.35fr] gap-[14px] flex-1 min-h-0">
          <div className="bg-white border border-[#eef1f4] rounded-[14px] p-[16px] flex flex-col">
            <Typography className="font-['Geist:SemiBold'] font-semibold text-[#0c221f] text-[14px] mb-[14px]">Delivery flow</Typography>
            <div className="flex-1">
              {seq.map((s, i) => (
            ...
            <div className="rounded-[11px] bg-[#f3fbf5] border border-[#cdeeda] p-[12px] flex items-center justify-between"><Typography className="font-['Geist:Medium'] text-[#06824f] text-[12px]">Avg delivery time</Typography><Typography className="font-['Geist:SemiBold'] font-semibold text-[#06824f] text-[14px]">2m 10s</Typography></div>
          </div>
          <div className="bg-white border border-[#eef1f4] rounded-[14px] flex flex-col overflow-hidden">
            <div className="px-[16px] py-[12px] border-b border-[#f1f3f6] grid grid-cols-[1.4fr_1.4fr_0.8fr_0.9fr] gap-[10px]">{['Patient', 'Document', 'Amount', 'Status'].map((h) => <Typography key={h} className="font-['Geist:Medium'] text-[#94a3b8] text-[10.5px] uppercase tracking-[0.5px]">{h}</Typography>)}</div>
            {rows.map((r) => (
              <div key={r.n} className="px-[16px] py-[12px] border-b border-[#f6f7f9] grid grid-cols-[1.4fr_1.4fr_0.8fr_0.9fr] gap-[10px] items-center">
                ...
                <span className={`justify-self-start rounded-full px-[9px] py-[3px] text-[10.5px] font-['Geist:Medium'] ${r.st === 'Viewed' ? 'bg-[#e5f6e7] text-[#06824f]' : 'bg-[#fff1d6] text-[#a06a00]'}`}>{r.st}</span>
              </div>
            ))}
          </div>
        </div>
...
const SECTIONS = [
  {
    problem: 'Manual Appointments',
    body: 'Patients still can’t book directly on WhatsApp. Staff check availability, confirm slots and follow up by hand.',
    pain: ['Missed appointments and lost revenue.', 'Patients wait longer for replies.', 'The front desk is overloaded all day.'],
    solution: 'One Platform for All Patient Communication',
    fix: ['Appointments, reports, reminders, FAQs and follow-ups in one system.', 'Full view of every patient’s journey.', 'One place for every conversation — no chaos.'],
    Mock: PlatformMock,
  },
  {
    problem: 'Repetitive Questions',
    body: 'Patients ask the same things all day — timings, location, services, doctors and costs.',
    pain: ['5–6 hours wasted every day on repeat questions.', 'Late replies during busy hours.', 'Frustrated staff and patients.'],
    solution: 'Smart Automation Made for Health Care',
    fix: ['AI handles booking, FAQs, reports, bills, reminders and follow-ups.', 'Staff step in only when a patient truly needs them.', 'Instant 24/7 replies — no message missed.'],
    Mock: AiReplyMock,
  },
  {
    problem: 'Paper-Based Reports & Billing',
    body: 'Reports, prescriptions and bills are printed or shared by hand — slow, and easy to lose.',
    pain: ['Operational inefficiency and manual work.', 'Documents lost or delivered late.', 'Poor patient experience.'],
    solution: 'Digital Reports & Billing on WhatsApp',
    fix: ['Send reports, prescriptions and bills to patients instantly.', 'Fully paperless operations.', 'Faster delivery, happier patients.'],
    Mock: CartRecoveryMock,
  },
  {
    problem: 'No Automated Follow-Ups',
    body: 'Patients forget appointments and follow-ups don’t always happen — driving up no-shows.',
    pain: ['High no-show rates.', 'Lost revenue.', 'Broken continuity of care.'],
    solution: 'Automated Reminders & Follow-Ups',
    fix: ['WhatsApp reminders auto-send before every appointment.', 'Better schedule management and fewer gaps.', 'Higher attendance and more revenue daily.'],
...
const STATS = [
  ...
  { v: '3X', l: 'Higher patient satisfaction' },
  { v: '5–6h', l: 'Staff time saved daily' },
  { v: '24/7', l: 'Always-on care AI' },
];

const TESTIMONIALS = [
  { q: 'Before WeNext, appointment booking on WhatsApp was completely manual and time-consuming. Now patients book directly through WhatsApp — fewer calls, less staff time, smoother for everyone.', c: 'Neehar Neuro', r: 'Neuro Clinic' },
  { q: 'We were drowning in messages across WhatsApp, Instagram and Facebook. WeNext brought everything into one place and our response time went from hours to minutes.', c: 'Fibers Club', r: 'Wellness' },
  { q: 'WeNext automated our repeated WhatsApp queries around availability and pricing. Patients get instant replies — a lifesaver during peak hours.', c: 'Swagruha Foods', r: 'Diagnostics' },
  { q: 'We were bleeding leads due to slow WhatsApp responses. WeNext fixed that — serious patients stay, noise is filtered, and our team works only on what matters.', c: 'Udaya Group', r: 'Hospital Group' },
];

const FAQS = [
  { q: 'Can patients really book appointments directly on WhatsApp?', a: 'Yes. Patients can book, reschedule or cancel appointments automatically, without staff involvement.' },
  { q: 'Will this reduce front-desk workload?', a: 'Yes. WeNext handles repetitive queries, bookings, reminders and follow-ups automatically.' },
  { q: 'What happens if multiple patients message at the same time?', a: 'All messages are handled instantly. No patient is missed, even during peak hours.' },
  { q: 'Can appointment reminders be sent automatically?', a: 'Yes. Automated WhatsApp reminders are sent before appointments to reduce no-shows.' },
  { q: 'Do we still need to manually answer common questions?', a: 'No. FAQs like timings, location, services and fees are answered automatically.' },
  { q: 'Can reports, prescriptions and bills be shared on WhatsApp?', a: 'Yes. Digital reports and billing can be sent securely to patients on WhatsApp.' },
];
      ...
      <div className="bg-[#092511] shadow-[0_0_0_100vmax_#092511] [clip-path:inset(0_-100vmax)] shrink-0 w-full">
        <div className="mx-[75px] border-x border-[rgba(255,255,255,0.08)] px-[75px] py-[96px] flex flex-col items-center text-center relative overflow-hidden">
          ...
          <div className="flex gap-[10px] items-center justify-center mb-[20px] relative">
            <div className="bg-[#06b349] size-[8px] rounded-full" />
            <Typography className="font-['Courier_Prime'] text-[#06b349] text-[14px] uppercase tracking-[0.2em]">Industries · Health Care</Typography>
          </div>
          <Typography component="h1" className="font-['Geist:SemiBold'] font-semibold leading-[1.1] text-white text-[60px] tracking-[-2px] max-w-[860px] mb-[22px] relative">
            Turn WhatsApp into your smart<br /><span className="text-[#25d366]">healthcare</span> assistant
          </Typography>
      ...
      <div className="mx-[75px] border-x border-b border-[#e0dac6]">
        <div className="py-[60px] px-[75px] flex flex-col items-center text-center">
          ...
          <Typography className="font-['Geist:Regular'] text-[#60584c] text-[18px] max-w-[600px] leading-[1.55] mt-[14px]">
            And exactly how WeNext fixes each one — turning manual, paper-heavy, no-show-prone operations into an automated patient-care engine.
          </Typography>
        </div>
      </div>
      ...
      <div className="bg-[#092511] shadow-[0_0_0_100vmax_#092511] [clip-path:inset(0_-100vmax)] shrink-0 w-full">
        <div className="mx-[75px] border-x border-[rgba(255,255,255,0.08)] px-[75px] py-[90px] flex flex-col items-center text-center relative overflow-hidden">
          ...
          <Typography component="h2" className="font-['Geist:SemiBold'] font-semibold leading-[1.12] text-white text-[46px] tracking-[-1.5px] max-w-[720px] mb-[18px] relative">
            Turn every patient message into care
          </Typography>
          <Typography className="font-['Geist:Regular'] text-[#a0b8a8] text-[19px] max-w-[600px] leading-[1.6] mb-[36px] relative">
            Clinics on WeNext respond 8× faster and cut no-shows with automated reminders. See it live.
          </Typography>
